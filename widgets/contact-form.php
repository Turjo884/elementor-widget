 ...
 * @since 1.0.0
 */
class Exdos_Contact_Form extends Widget_Base {
	...
	public function get_title() {
		return __( 'Exdos Contact Form', 'exdos-core' );
	}
	...
	protected function register_controls_section() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Contact Form', 'exdos-core' ),
			]
		);

		$this->add_control(
			'exdos_form_shortcode',
			[
				'label' => __( 'Form Shortcode', 'exdos-core' ),
	...
	protected function render() {
		...
		?>
			...
			<div class="contact-form-box">
					<p><?php echo do_shortcode($settings['exdos_form_shortcode'])?></p>
			</div>
...
$widgets_manager->register( new Exdos_Contact_Form() );
